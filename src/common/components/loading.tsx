      ...
      {['#fc0c', '#fd5d', '#fffc'].map((color, i) => (
        <svg key={i} viewBox='0 -87 463.83425 463' xmlns='http://www.w3.org/2000/svg'>
          <filter id='glass'>
            ...
            <feComposite in2='SourceAlpha' operator='in' result='backgroundBlur'></feComposite>
          </filter>
          <path
            filter='url(#glass)'
...
const StyledComponent = styled(Component)`
  ...
  > div {
    ...
    svg {
      filter: drop-shadow(1px 1px 2px #fff4) drop-shadow(2px 2px 3px #0002);
      position: absolute;
      top: 50%;
      left: 50%;
      transition: all;
    ...
    &:before {
      ...
      width: 100%;
      height: 20px;
      background-image: radial-gradient(#a804 20%, #a802 40%, transparent 60%);
    }
  }
